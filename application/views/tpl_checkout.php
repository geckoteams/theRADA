...
<!-- Load the required Braintree client component - Begin -->
	...
	if(isset($_GET['insID']))
	{
		...
		{
			$nvname = $user->name;
			$nvcenter_name = $user->center_name;
			$nvtotal_amount = $user->total_amount;
			$nvemail = $user->email;
		}
		?>
		<div class="row">
			...
			<div class="col-md-4">
				...
				<table style="border-collapse: separate; border-spacing: 0 .5em;">
					<form id="bt-hsf-checkout-form" action="<?php echo base_url('payment/'); ?>" method="post">
						<input type="hidden" name="first_name" id="first_name" value="<?php echo $nvname;?>"/>
						<input type="hidden" name="last_name" id="last_name" value="<?php echo $nvcenter_name;?>"/>
						...
						<input type="hidden" name="userid" value="<?php echo $_GET['insID'];?>"/>
						<br/>
						<tr>
							<td>
						...
						<tr>
							<td><input type="hidden" name="currencyCodeType" value="USD"/>
								<input type="hidden" name="paymentAmount" value="<?php echo $nvtotal_amount;?>"/>
	...
	<script type="text/javascript">
		...
		var recipientName = '<?php echo $nvname;?>'+ ' '+ '<?php echo $nvcenter_name;?>';
		var line1 = '';
		var line2 = '';
		var city = '';
		var state = '';
				...
				paypal.Button.render({
					...
					payment: function () {
						return paypalCheckoutInstance.createPayment({
							flow: 'checkout',
							intent: 'sale',
							amount: <?php echo $nvtotal_amount;?>,
							currency: 'USD',
							locale: 'en_US',
