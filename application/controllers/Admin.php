...
//					$passwordTeacher=$this->Database->generateRandomString(10);
					$passwordParent=$this->Database->getPassword($_POST['parent_1_email']);
					$passwordParent2=$this->Database->getPassword($_POST['parent_2_email']);
					$passwordClinician=$this->Database->getPassword($_POST['clinician_email']);
					$passwordTeacher=$this->Database->getPassword($_POST['teacher_email']);
											 
					$passString=array();
					$passString[$_POST['parent_1_email']] = $passwordParent;
					$passString[$_POST['parent_2_email']] = $passwordParent2;
					$passString[$_POST['clinician_email']] = $passwordClinician;
					$passString[$_POST['teacher_email']] = $passwordTeacher;
						...
						//check and send mail to parent 1
							if($_POST['parent_1_email']!='')
							{
								...
								if($this->Database->checkeAllreadyExist('users','email',$createParentEmail)=='true')
								{
									...
									$headers .= "Return-Path: no-reply@therada.co.uk\r\n";
									$headers .= 'From: no-reply@therada.co.uk' . "\r\n";
									$headers .= "X-Priority: 3\r\n";
									$headers .= "X-Mailer: PHP". phpversion() ."\r\n" ;
									
									/*$nvemailmsg = "This is a message from www.therada.co.uk who has successfully log you as a parent for ".$_POST['name'].".<BR><BR>You can now log in using your email address ".$createParentEmail." and this password ".$passwordParent.".<BR>  Thank you";*/
									$nvemailmsg = "";
									
									$nvemailmsg.="The clinician who is working with ".$_POST['name']." has asked you to complete the CAPA-RAD assessment about ".$_POST['name']."'s social relationships. Please follow the instructions below to complete the online questionnaires.<br>";
									$nvemailmsg.="1. go to <a href='http://www.therada.co.uk'>www.therada.co.uk</a><br>";
									$nvemailmsg.="2. log on with the email:".$createParentEmail." and password: ".$passwordParent."<br>";
									$nvemailmsg.="3. register your details (you can use child initials)<br>";
									$nvemailmsg.="4. complete the parent RPQ questionnaire<br>";
									$nvemailmsg.="5. Complete the CAPA-RAD questionnaire<br><br><br>";
									$nvemailmsg.="Thank you for your help.<br>The CAPA-RAD.com team";
						...
						//check and send mail to parent 2
							if($_POST['parent_2_email']!='')
							{
								...
								if($this->Database->checkeAllreadyExist('users','email',$createParentEmail)=='true')
								{
									...
									/*$nvemailmsg = "This is a message from www.therada.co.uk who has successfully log you as a parent for ".$_POST['name'].".\r\n\r\nYou can now log in using your email address ".$createParentEmail." and this password ".$passwordParent2.".<BR>  Thank you";*/
									$nvemailmsg = "";
									
									$nvemailmsg.="The clinician who is working with ".$_POST['name']." has asked you to complete the CAPA-RAD assessment about ".$_POST['name']."'s social relationships. Please follow the instructions below to complete the online questionnaires.<br>";
									$nvemailmsg.="1. go to <a href='http://www.therada.co.uk'>www.therada.co.uk</a><br>";
									$nvemailmsg.="2. log on with the email:".$createParentEmail." and password: ".$passwordParent2."<br>";
									$nvemailmsg.="3. register your details (you can use child initials)<br>";
									$nvemailmsg.="4. complete the parent RPQ questionnaire<br>";
									$nvemailmsg.="5. Complete the CAPA-RAD questionnaire<br><br><br>";
									$nvemailmsg.="Thank you for your help.<br>The CAPA-RAD.com team";
						...
						//check and send mail to clinical
							...
							if($_POST['clinician_email']!='')
							{
								...
								if($this->Database->checkeAllreadyExist('users','email',$createClinicalEmail)=='true')
								{
									...
									/*$nvemailmsg = "This is a message from www.therada.co.uk who has successfully log you as a clinician for ".$_POST['name'].".\r\n\r\nYou can now log in using your email address ".$userdata[0]->email." and this password ".$passwordClinician.".<BR>  Thank you";*/
									$nvemailmsg = "";
									
									$nvemailmsg.="Dear clinician, ".$_POST['name']."’s parent and teacher have been asked to complete the CAPA-RAD and RPG, you can view the answers to these questionnaires by logging into the website as follows:<br>";
									$nvemailmsg.="1. go to <a href='http://www.therada.co.uk'>www.therada.co.uk</a><br>";
									$nvemailmsg.="2. Log on with the email:".$userdata[0]->email." and password: ".$passwordClinician."<br>";
									$nvemailmsg.="3. The clinician summary page provides an overview of the findings from these assessments, however you can use the links on the website to look directly at the responses given from the parent and teacher.<br><br><br>";
									$nvemailmsg.="Thank you for your help.<br>The CAPA-RAD.com team";
//									mail($email,"You Registration Successfully!",$nvemailmsg,$headers);
								...
								else
								{
									...
									$nvemailmsg.="Dear clinician, ".$_POST['name']."’s parent and teacher have been asked to complete the CAPA-RAD and RPG, you can view the answers to these questionnaires by logging into the website as follows:<br>";
									$nvemailmsg.="1. go to <a href='http://www.therada.co.uk'>www.therada.co.uk</a><br>";
									$nvemailmsg.="2. Log on with the email:".$createClinicalEmail." and password: ".$passwordClinician."<br>";
									$nvemailmsg.="3. The clinician summary page provides an overview of the findings from these assessments, however you can use the links on the website to look directly at the responses given from the parent and teacher.<br><br><br>";
									$nvemailmsg.="Thank you for your help.<br>The CAPA-RAD.com team";
//									mail($email,"You Registration Successfully!",$nvemailmsg,$headers);
						...
						if($_POST['teacher_email'] != "")
						{
							...
							if($this->Database->checkeAllreadyExist('users','email',$createTeacherEmail)=='true')
							{
								...
								/*$nvemailmsg = "This is a message from www.therada.co.uk who has successfully log you as a teacher for ".$_POST['name'].".\r\n\r\nYou can now log in using your email address ".$userdata[0]->email." and this password ".$passwordTeacher.".<BR>  Thank you";*/
								
								$nvemailmsg.="The clinician who is working with ".$_POST['name']." has requested some additional information from the school about ".$_POST['name']."’s social relationships. ".$_POST['name']."’s parents have given permission for you to complete this short online questionnaire (this should take no longer than 10 minutes). Please access using the following instructions <br>";
								
								$nvemailmsg.="1. go to <a href='http://www.therada.co.uk'>www.therada.co.uk</a><br>";
								$nvemailmsg.="2. Log on with the email:".$userdata[0]->email." and password: ".$passwordTeacher."<br>";
								$nvemailmsg.="3. Complete the teacher RPQ questionnaire<br><br><br>";
								$nvemailmsg.="Thank you for your help.<br>The CAPA-RAD.com team";
...
//								mail($email,"You Registration Successfully!",$nvemailmsg,$headers);
							...
							else
							{
								...
								/*$nvemailmsg = "This is a message from www.therada.co.uk who has successfully log you as a teacher for ".$_POST['name'].". You can now log in using your email address ".$createTeacherEmail." and this password ".$passwordTeacher.".<BR>  Thank you";*/
								...
								$nvemailmsg.="1. go to <a href='http://www.therada.co.uk'>www.therada.co.uk</a><br>";
								$nvemailmsg.="2. Log on with the email:".$createTeacherEmail." and password: ".$passwordTeacher."<br>";
								$nvemailmsg.="3. Complete the teacher RPQ questionnaire<br><br><br>";
								$nvemailmsg.="Thank you for your help.<br>The CAPA-RAD.com team";
...
//								mail($email,"You Registration Successfully!",$nvemailmsg,$headers);
		...
		public function editChildren()
		{
			...
			$p_data = array();
			$p_data[$val[0]->parent_1_email] = '';
			$p_data[$val[0]->parent_2_email] = '';
			$p_data[$val[0]->clinician_email] = '';
			$p_data[$val[0]->teacher_email] = '';
			
			if(!empty($val[0]->p_data))
			{
				$p_data=@unserialize($val[0]->p_data);
			}
			...
			$output.='<input type="hidden" name="childid" value="'.$_POST['childid'].'" class="gid">
				...
				<div class="form-row">
					...
					<span class="pwd">Pwd: '.$p_data[$val[0]->clinician_email].'</span>
				</div>
				<div class="form-row">
					...
					<span class="pwd">Pwd: '.$p_data[$val[0]->parent_1_email].'</span>
				</div>
				<div class="form-row">
					...
					<span class="pwd">Pwd: '.$p_data[$val[0]->parent_2_email].'</span>
				</div>
				<div class="form-row">';
					...
					<span class="pwd">Pwd: '.$p_data[$val[0]->teacher_email].'</span>
				</div>
				<div class="form-row">
					<div class="row">
						<div class="col-xs-12">
